...
void ImGui::ShowDemoWindow(bool* p_open)
{
	...
	static bool show_app_node_editor = false;
	...
	if (show_app_node_editor)		ShowExampleAppCustomNodeGraph(&show_app_node_editor);
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
			...
			ImGui::MenuItem("Node editor", NULL, &show_app_node_editor);
            ImGui::EndMenu();
        }
